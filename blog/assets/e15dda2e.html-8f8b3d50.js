import{_ as t,r as p,o,c as i,a as n,b as a,d as e,e as c}from"./app-64d7caa4.js";const l={},u=c(`<h2 id="compose-屏幕适配" tabindex="-1"><a class="header-anchor" href="#compose-屏幕适配" aria-hidden="true">#</a> Compose 屏幕适配</h2><p>一种<strong>Compose</strong>中屏幕适配的解决方案，灵感参考<em>头条屏幕适配</em>、<em>AndroidAutoSize</em>等，以设计稿宽度和屏幕水平方法大小为准，等比拉伸控件大小。</p><p>后文附有本方案的 Kotlin 语言实现，使用只需要两个步骤即可：</p><div class="language-kotlin line-numbers-mode" data-ext="kt"><pre class="language-kotlin"><code><span class="token comment">// 1 初始化</span>
