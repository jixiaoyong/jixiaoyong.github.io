import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o,c as l,a as n,b as s,d as e,e as i}from"./app-b6af1138.js";const c={},u=n("h1",{id:"简介",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#简介","aria-hidden":"true"},"#"),s(" 简介")],-1),r=n("p",null,"更新内容：",-1),d={href:"http://gityuan.com",target:"_blank",rel:"noopener noreferrer"},k=n("li",null,"汇总信息输出 config.json 为后面的客户端做准备",-1),v=i(`<p>更新文件：</p><ul><li>spider_main.py</li><li>html_output.py</li><li><strong>gityuan_urls.py</strong></li><li><strong>html_downloader.py</strong></li></ul><h1 id="代码" tabindex="-1"><a class="header-anchor" href="#代码" aria-hidden="true">#</a> 代码</h1><ul><li><strong>spider_main.py</strong></li></ul><p>作为入口类，主要增加了初始化所有 URL，以及便利这些 URL 的功能。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>sp <span class="token operator">=</span> SpiderMain<span class="token punctuation">(</span><span class="token punctuation">)</span>
