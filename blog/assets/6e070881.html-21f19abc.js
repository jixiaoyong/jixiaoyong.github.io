import{_ as t,r as p,o,c as l,a as n,b as s,d as e,e as i}from"./app-f3f62fb0.js";const c={},u=n("h2",{id:"简介",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#简介","aria-hidden":"true"},"#"),s(" 简介")],-1),r=n("p",null,"更新内容：",-1),d={href:"http://gityuan.com",target:"_blank",rel:"noopener noreferrer"},k=n("li",null,"汇总信息输出 config.json 为后面的客户端做准备",-1),v=i(`<p>更新文件：</p><ul><li>spider_main.py</li><li>html_output.py</li><li><strong>gityuan_urls.py</strong></li><li><strong>html_downloader.py</strong></li></ul><h2 id="代码" tabindex="-1"><a class="header-anchor" href="#代码" aria-hidden="true">#</a> 代码</h2><ul><li><strong>spider_main.py</strong></li></ul><p>作为入口类，主要增加了初始化所有 URL，以及便利这些 URL 的功能。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code>sp <span class="token operator">=</span> SpiderMain<span class="token punctuation">(</span><span class="token punctuation">)</span>
...
<span class="token keyword">def</span> <span class="token function">craw</span><span class="token punctuation">(</span>self<span class="token punctuation">,</span> root_urls<span class="token punctuation">,</span> file_name<span class="token punctuation">)</span><span class="token punctuation">:</span>
        ...
        <span class="token keyword">while</span> self<span class="token punctuation">.</span>urls<span class="token punctuation">.</span>has_next<span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
            ...
            <span class="token comment">#等待 3s，防止太频繁访问被识别</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="结语" tabindex="-1"><a class="header-anchor" href="#结语" aria-hidden="true">#</a> 结语</h2>`,19),m={href:"http://gityuan.com",target:"_blank",rel:"noopener noreferrer"},b=n("ol",null,[n("li",null,[s("没有伪装，爬虫"),n("strong",null,"很容易"),s("被识别并被拒绝服务（"),n("s",null,"就在刚刚写下这句话的时候，就发生了被限制访问，真*乌鸦嘴"),s("）。")]),n("li",null,"由于原网站特性，其置顶文章每页都有，会导致部分数据重复。"),n("li",null,"未爬取具体文章内容。")],-1),_=n("p",null,[n("strong",null,"说明")],-1),g={href:"http://gityuan.com/",target:"_blank",rel:"noopener noreferrer"},h=n("h2",{id:"源码",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#源码","aria-hidden":"true"},"#"),s(" 源码")],-1),f={href:"https://github.com/jixiaoyong/AndroidNote/tree/master/code/2018-1-26/gityuan_spider",target:"_blank",rel:"noopener noreferrer"},y=n("p",null,[n("code",null,"tag"),s("为"),n("code",null,"gityuan_spider1.5")],-1);function w(q,x){const a=p("ExternalLinkIcon");return o(),l("div",null,[u,r,n("ul",null,[n("li",null,[s("爬取 "),n("a",d,[s("gityuan.com"),e(a)]),s(" 网站所有文章列表并输出 json")]),k]),v,n("p",null,[s("当前爬虫主体功能以及实现，可以爬取 "),n("a",m,[s("gityuan.com"),e(a)]),s(" 所有有效文章列表，可以满足客户端需求。但仍然存在以下问题：")]),b,n("blockquote",null,[_,n("p",null,[s("本文只为学术研究，其中涉及到的第三方网站及其所有资源均属原主所有。向 gityuan 大神致敬，欢迎访问其"),n("a",g,[s("blog"),e(a)]),s("。")])]),h,n("p",null,[n("a",f,[s("github 链接"),e(a)])]),y])}const j=t(c,[["render",w],["__file","6e070881.html.vue"]]);export{j as default};
