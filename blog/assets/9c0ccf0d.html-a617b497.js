import{_ as e,r as o,o as i,c,a as n,b as s,d as t,e as p}from"./app-bf457b07.js";const l={},u=n("h2",{id:"简介",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#简介","aria-hidden":"true"},"#"),s(" 简介")],-1),r=n("blockquote",null,[n("p",null,"本文基于 Python2.7")],-1),d=n("a",{href:"www.imooc.com"},"慕课网",-1),k={href:"http://gityuan.com",target:"_blank",rel:"noopener noreferrer"},v=n("p",null,"本文即上述过程整理。",-1),m={href:"https://github.com/jixiaoyong/AndroidNote/tree/master/code/2018-1-26/gityuan_spider",target:"_blank",rel:"noopener noreferrer"},b=p('<h2 id="框架" tabindex="-1"><a class="header-anchor" href="#框架" aria-hidden="true">#</a> 框架</h2><p>爬虫主要活动是：</p><ol><li>爬取目标网页内容</li><li>对获取到的内容进行分析，获取有用数据</li><li>将处理好的数据按格式输出</li></ol><p>此外还需要有一个专门管理爬虫活动的主类，故而文件结构如下：</p><ol><li>spider_main.py 入口类</li><li>url_manager.py 管理要下载的链接</li><li>html_downloader.py 下载网页内容</li><li>html_paeser.py 对获取到的数据进行解析、加工</li><li>html_out.py 输出格式化的数据</li></ol>',5),_={href:"http://gityuan.com",target:"_blank",rel:"noopener noreferrer"},f=p(`<h2 id="关键代码" tabindex="-1"><a class="header-anchor" href="#关键代码" aria-hidden="true">#</a> 关键代码</h2><p><strong>spider_main.py</strong></p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">#导入用到的各个类</span>
