...
const applyTheme = (theme) => {
    ...
    if (hljsThemeLink) {
        hljsThemeLink.href = effectiveTheme === 'dark' 
            ? 'https://cdn.staticfile.net/highlight.js/11.7.0/styles/github-dark.min.css'
            : 'https://cdn.staticfile.net/highlight.js/11.7.0/styles/github.min.css';
    }
    ...
    if (homeDiv && homeDiv.dataset.totalPosts) {
        ...
        const loadMorePosts = async () => {
            ...
            try {
                ...
                if (!allPostsData) {
                    const searchJsonPath = isEnglish ? '/en/search.json' : '/search.json';
